...
- [ ] **Phase 1: Foundation and Authentication** - Project setup, Supabase schema, invite-code registration, login, role-based routing, and base UI with design system
...
|-------|----------------|--------|-----------|
| 1. Foundation and Authentication | 0/2 | Not started | - |
