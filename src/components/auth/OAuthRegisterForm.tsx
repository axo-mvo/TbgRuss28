...
import { validateInviteCode, getRegisteredYouth, completeOAuthProfile } from '@/lib/actions/auth'
...
export default function OAuthRegisterForm() {
  ...
  return (
    <Card className="w-full max-w-[400px] mx-auto">
      <p className="text-sm text-text-muted mb-4">
        Fullfør registreringen — steg {step} av 2
      </p>
